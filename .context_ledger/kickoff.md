...
>   `https://github.com/TisoneK/ClickTrader.git`, read `.context_ledger/kickoff.md`, follow it."* If the
...
- **Project name:** ClickTrader
- **Project repository URL:** https://github.com/TisoneK/ClickTrader.git
...
- **Cloud/sandbox agent** — clone the project repo only:
  ...
  git clone <PROJECT_REPO_URL_WITH_TOKEN_IF_PRIVATE> ClickTrader && cd ClickTrader
  git remote set-url origin https://github.com/TisoneK/ClickTrader.git
